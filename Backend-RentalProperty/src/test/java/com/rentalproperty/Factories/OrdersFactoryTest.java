...
//        unit = UnitFactory.getUnit(unitId,unitValues,unitType,unitPrice,bathroom,parking, occupation);
...
//        date = new Date();
//        ordersId = 1;
//        orders = OrdersFactory.getOrders(ordersId, resident,date,orderLineList);
...
//        resident = ResidentFactory.getResident(residentId,residentValues);
//
//
//
//    }
...
//        assertEquals(true, orders.equals(orders));
//    }
